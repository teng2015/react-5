    ...
    if (navigator.userAgent.indexOf('Chrome') > -1) {
      if (typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ === 'undefined') {
        console.debug(
          ...
          'https://fb.me/browser-sync-devtools'
        );
      }
    }
    ...
    for (var i = 0; i < expectedFeatures.length; i++) {
      if (!expectedFeatures[i]) {
        console.error(
          ...
          'https://fb.me/browser-sync-warning-polyfills'
        );
        break;
      }
    }
...
var ReactClassInterface = {
   ...
   *
   * Use this as an opportunity to browser-sync to a prop transition by updating the
    ...
    var Constructor = function(props, context) {
      ...
      if ("production" !== "development") {
        ("production" !== "development" ? warning(
          ...
          'JSX instead. See: https://fb.me/browser-sync-legacyfactory'
        ) : null);
      }
...
if ("production" !== "development") {
  var deprecatedAPIs = {
    ...
    replaceState: [
      ...
      'https://github.com/facebook/browser-sync/issues/3236).'
    ],
    setProps: [
      'setProps',
      'Instead call React.render again at the top level.'
   ...
   _warnIfContextsDiffer: function(ownerBasedContext, parentBasedContext) {
    ...
    for (var i = 0; i < parentKeys.length; i++) {
      ...
      ("production" !== "development" ? warning(
        ...
        '(see: http://fb.me/browser-sync-context-by-parent)',
...
function assertValidProps(props) {
  ...
  if (props.dangerouslySetInnerHTML != null) {
    ...
    ("production" !== "development" ? invariant(
      ...
      'Please visit https://fb.me/browser-sync-invariant-dangerously-set-inner-html ' +
...
function warnAndMonitorForKeyUse(message, element, parentType) {
  ...
  ("production" !== "development" ? warning(
    false,
    message + '%s%s See https://fb.me/browser-sync-warning-keys for more information.',
 ...
 * but modified to be suitable for browser-sync and has a couple of bug fixes (doesn't
...
var ReactMarkupChecksum = {
  CHECKSUM_ATTR_NAME: 'data-browser-sync-checksum',
